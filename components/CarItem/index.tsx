  ...
  return (
    <View style={styles.carContainer}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>LekanTesla X</Text>
        <TouchableOpacity>
      ...
      <ScrollView>
        ...
        <View style={styles.controls}>
          <TouchableOpacity style={styles.controlsButtonExc}>
          ...
          <TouchableOpacity onPress={clickLock} style={styles.controlsButton}>
            <FontAwesomeIcon
              style={styles.icon}
